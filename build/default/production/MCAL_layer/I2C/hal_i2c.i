...
# 33 "MCAL_layer/I2C/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
static InterruptHandler I2C_Report_Write_Collision_InterruptHandler = ((void*)0);
static InterruptHandler I2C_DefaultInterruptHandle = ((void*)0);
static InterruptHandler I2C_Report_Receive_Overflow_InterruptHandle = ((void*)0);


static __attribute__((inline)) void I2C_Master_Mode_Clock_Configurations(const I2C_t *_i2c);
static __attribute__((inline)) void I2C_Mode_GPIO_Configurations(void);
static __attribute__((inline)) void I2C_Interrupt_Configurations(const I2C_t *_i2c);
static __attribute__((inline)) void I2C_Slave_Mode_Configurations(const I2C_t *_i2c);
...
Std_ReturnType I2C_Initialize(const I2C_t *_i2c){
    ...
    }else
    {
        ...
        else if(_i2c->i2c_mode==0){

            if(1 == _i2c->i2c_general_call){
                SSPCON2bits.GCEN = 1;
            }
            else if(0 == _i2c->i2c_general_call){
                SSPCON2bits.GCEN = 0;
            }
            else { }
        ...
        if(0==_i2c->i2c_slew_rate){
            SSPSTATbits.SMP = 0;
        }
        else if(1==_i2c->i2c_slew_rate){
            SSPSTATbits.SMP = 1;
        }
        else{ }

        if(1==_i2c->i2c_SMBus_control){
            SSPSTATbits.CKE = 1;
        }
        else if(0==_i2c->i2c_SMBus_control){
            SSPSTATbits.CKE = 0;
        }
        else{ }
...
Std_ReturnType I2C_Master_Read_Blocking(const I2C_t *_i2c, uint8_t ack, uint8_t *i2c_data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((((void*)0) == _i2c)||(((void*)0) == i2c_data))
    {
        ret = (Std_ReturnType)0x00;
    }else
    {
...
static __attribute__((inline)) void I2C_Master_Mode_Clock_Configurations(const I2C_t *_i2c){
    ...
    SSPADD = (uint8_t)(((8000000UL / 4) / _i2c->i2c_clock) - 1);
}
