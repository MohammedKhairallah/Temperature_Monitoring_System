...
# 37 "MCAL_layer/Timer3/../mcal_std_types.h"
...
# 55 "MCAL_layer/Timer3/../Interrupt/mcal_interrupt_cfg.h"
...
# 7 "MCAL_layer/Timer3/hal_timer3.c" 2
 ...
 static __attribute__((inline)) void Timer3_Mode_Select(const Timer3_t *timer3_obj);
static __attribute__((inline)) void Timer3_WR_Register_Size_config(const Timer3_t *timer3_obj);

static uint16_t Timer3_preload = 0x00;
# 29 "MCAL_layer/Timer3/hal_timer3.c"
Std_ReturnType Timer3_Initialize(const Timer3_t *timer3_obj){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer3_obj)
    {
    ...
    }else
    {
        ...
        (T3CONbits.T3CKPS = (timer3_obj->Timer3_Prescaler_Value));
...
# 76 "MCAL_layer/Timer3/hal_timer3.c"
        (T3CONbits.TMR3ON = 1);
    }
    return ret;
}
# 90 "MCAL_layer/Timer3/hal_timer3.c"
Std_ReturnType Timer3_Deinitialize(const Timer3_t *timer3_obj){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer3_obj)
    {
...
# 117 "MCAL_layer/Timer3/hal_timer3.c"
Std_ReturnType Timer3_Write_value(const Timer3_t *timer3_obj, uint16_t value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer3_obj)
    {
...
# 140 "MCAL_layer/Timer3/hal_timer3.c"
Std_ReturnType Timer3_Read_value(const Timer3_t *timer3_obj, uint16_t *value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8_t Timer3_L = 0x00;
    uint8_t Timer3_H = 0x00;
    if((((void*)0) == timer3_obj)||(((void*)0) == value))
    {
        ret = (Std_ReturnType)0x00;
    }else
    {
...
static __attribute__((inline)) void Timer3_Mode_Select(const Timer3_t *timer3_obj){
    ...
    if(0 == timer3_obj->Timer3_Mode){
        (T3CONbits.TMR3CS = 0);
    }
    else if(1 == timer3_obj->Timer3_Mode){
        (T3CONbits.TMR3CS = 1);

        if(1 == timer3_obj->Timer3_Counter_Mode){
            (T3CONbits.T3SYNC = 1);
        }
        else if(0 == timer3_obj->Timer3_Counter_Mode){
            (T3CONbits.T3SYNC = 0);
        }
        else{ }
    }
...
static __attribute__((inline)) void Timer3_WR_Register_Size_config(const Timer3_t *timer3_obj){
    if(1==timer3_obj->Timer3_WR_Reg_Mode){
        (T3CONbits.RD16 = 1);
    }
    else if(0==timer3_obj->Timer3_WR_Reg_Mode){
        (T3CONbits.RD16 = 0);
    }
    else{ }
}
