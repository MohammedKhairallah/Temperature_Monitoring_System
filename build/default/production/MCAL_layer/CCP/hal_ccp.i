...
# 37 "MCAL_layer/CCP/../mcal_std_types.h"
...
# 55 "MCAL_layer/CCP/../Interrupt/mcal_interrupt_cfg.h"
...
Std_ReturnType CCP_Initialize(const ccp_t *_ccp_obj){
    ...
    }else
    {
        ...
        if(CCP1_MODULE == _ccp_obj->ccp_module){
            (CCP1CONbits.CCP1M = ((uint8_t)0x00));
        }
        else if(CCP2_MODULE == _ccp_obj->ccp_module){
            (CCP2CONbits.CCP2M = ((uint8_t)0x00));
        }
        else{ }
...
# 219 "MCAL_layer/CCP/hal_ccp.c"
Std_ReturnType CCP_PWM_Set_Duty(const ccp_t *_ccp_obj, const uint8_t _duty){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint16_t l_duty_temp = 0x00;
    if(((void*)0) == _ccp_obj)
    {
        ret = (Std_ReturnType)0x00;
    }else
...
Std_ReturnType CCP_PWM_Start(const ccp_t *_ccp_obj){
    ...
    {
        if(CCP1_MODULE == _ccp_obj->ccp_module){
            CCP1CONbits.CCP1M = ((uint8_t)0x0C);
        }
        else if(CCP2_MODULE == _ccp_obj->ccp_module){
            CCP2CONbits.CCP2M = ((uint8_t)0x0C);
        }
        else{ }
    }
    return ret;
...
static void CCP_Interrupt_Config(const ccp_t *_ccp_obj){
# 345 "MCAL_layer/CCP/hal_ccp.c"
}


static void CCP_PWM_Mode_Config(const ccp_t *_ccp_obj){

    PR2 = (uint8_t)(((float)8000000UL / ((float)_ccp_obj->PWM_Frequency * 4.0 * (float)_ccp_obj->timer2_prescaler_value *
                    (float)_ccp_obj->timer2_postscaler_value)) - 1);
    if(CCP1_MODULE == _ccp_obj->ccp_module){
        if(((uint8_t)0x0C) == _ccp_obj->ccp_mode_variant){
            (CCP1CONbits.CCP1M = ((uint8_t)0x0C));
        }
        else { }
    }
...
static Std_ReturnType CCP_Capture_Mode_Config(const ccp_t *_ccp_obj){
    ...
    if(CCP1_MODULE == _ccp_obj->ccp_module){
        ...
        switch(_ccp_obj->ccp_mode_variant){
            case ((uint8_t)0x04):
                (CCP1CONbits.CCP1M = ((uint8_t)0x04));
                break;
            case ((uint8_t)0x05):
                (CCP1CONbits.CCP1M = ((uint8_t)0x05));
                break;
            case ((uint8_t)0x06):
                (CCP1CONbits.CCP1M = ((uint8_t)0x06));
                break;
            case ((uint8_t)0x07):
                (CCP1CONbits.CCP1M = ((uint8_t)0x07));
                break;
        ...
        switch(_ccp_obj->ccp_mode_variant){
            case ((uint8_t)0x04):
                (CCP2CONbits.CCP2M = ((uint8_t)0x04));
                break;
            case ((uint8_t)0x05):
                (CCP2CONbits.CCP2M = ((uint8_t)0x05));
                break;
            case ((uint8_t)0x06):
                (CCP2CONbits.CCP2M = ((uint8_t)0x06));
                break;
            case ((uint8_t)0x07):
                (CCP2CONbits.CCP2M = ((uint8_t)0x07));
                break;
            default : ret = (Std_ReturnType)0x00;
        }
    }
...
static Std_ReturnType CCP_Compare_Mode_Config(const ccp_t *_ccp_obj){
    ...
    if(CCP1_MODULE == _ccp_obj->ccp_module){
        ...
        switch(_ccp_obj->ccp_mode_variant){
            case ((uint8_t)0x08):
                (CCP1CONbits.CCP1M = ((uint8_t)0x08));
                break;
            case ((uint8_t)0x09):
                (CCP1CONbits.CCP1M = ((uint8_t)0x09));
                break;
            case ((uint8_t)0x02):
                (CCP1CONbits.CCP1M = ((uint8_t)0x02));
                break;
            case ((uint8_t)0x0A):
                (CCP1CONbits.CCP1M = ((uint8_t)0x0A));
                break;
            case ((uint8_t)0x0B):
                (CCP1CONbits.CCP1M = ((uint8_t)0x0B));
                break;
            default : ret = (Std_ReturnType)0x00;
        }
    }
        ...
        switch(_ccp_obj->ccp_mode_variant){
            case ((uint8_t)0x08):
                (CCP2CONbits.CCP2M = ((uint8_t)0x08));
                break;
            case ((uint8_t)0x09):
                (CCP2CONbits.CCP2M = ((uint8_t)0x09));
                break;
            case ((uint8_t)0x02):
                (CCP2CONbits.CCP2M = ((uint8_t)0x02));
                break;
            case ((uint8_t)0x0A):
                (CCP2CONbits.CCP2M = ((uint8_t)0x0A));
                break;
            case ((uint8_t)0x0B):
                (CCP2CONbits.CCP2M = ((uint8_t)0x0B));
                break;
            default : ret = (Std_ReturnType)0x00;
        }
    }
