...
# 33 "MCAL_layer/ADC/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 55 "MCAL_layer/ADC/../Interrupt/mcal_interrupt_cfg.h"
...
static __attribute__((inline)) void select_result_format(const adc_conf_t *ADC_obj);
static __attribute__((inline)) void configure_voltage_reference(const adc_conf_t *ADC_obj);
...
Std_ReturnType ADC_Get_Conversion_Result(const adc_conf_t *ADC_obj, uint16_t *Conversion_Result){
    ...
    {
        if(0x01U==ADC_obj->Result_Format){
            *Conversion_Result = (uint16_t)((ADRESH << 8) + ADRESL);
        }
        else if(0x00U==ADC_obj->Result_Format){
