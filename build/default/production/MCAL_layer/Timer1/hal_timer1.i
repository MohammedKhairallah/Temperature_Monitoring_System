...
# 55 "MCAL_layer/Timer1/../Interrupt/mcal_interrupt_cfg.h"
...
static __attribute__((inline)) void Timer1_Mode_Select(const Timer1_t *timer1_obj);
static __attribute__((inline)) void Timer1_WR_Register_Size_config(const Timer1_t *timer1_obj);


static uint16_t Timer1_preload = 0x00;
# 30 "MCAL_layer/Timer1/hal_timer1.c"
Std_ReturnType Timer1_Initialize(const Timer1_t *timer1_obj){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer1_obj)
    {
    ...
    }else
    {
        ...
        (T1CONbits.T1CKPS = (timer1_obj->Timer1_Prescaler_Value));
...
# 76 "MCAL_layer/Timer1/hal_timer1.c"
        (T1CONbits.TMR1ON = 1);
    }
    return ret;
}
# 90 "MCAL_layer/Timer1/hal_timer1.c"
Std_ReturnType Timer1_Deinitialize(const Timer1_t *timer1_obj){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer1_obj)
    {
...
# 117 "MCAL_layer/Timer1/hal_timer1.c"
Std_ReturnType Timer1_Write_value(const Timer1_t *timer1_obj, uint16_t value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer1_obj)
    {
...
# 140 "MCAL_layer/Timer1/hal_timer1.c"
Std_ReturnType Timer1_Read_value(const Timer1_t *timer1_obj, uint16_t *value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8_t Timer1_L = 0x00;
    uint8_t Timer1_H = 0x00;
    if((((void*)0) == timer1_obj)||(((void*)0) == value))
    {
        ret = (Std_ReturnType)0x00;
    }else
    {
...
static __attribute__((inline)) void Timer1_Mode_Select(const Timer1_t *timer1_obj){
    ...
    if(0 == timer1_obj->Timer1_Mode){
        (T1CONbits.TMR1CS = 0);
    }
    else if(1 == timer1_obj->Timer1_Mode){
        (T1CONbits.TMR1CS = 1);

        if(1 == timer1_obj->Timer1_Counter_Mode){
            (T1CONbits.T1SYNC = 1);
        }
        else if(0 == timer1_obj->Timer1_Counter_Mode){
            (T1CONbits.T1SYNC = 0);
        }
        else{ }
    }
...
static __attribute__((inline)) void Timer1_WR_Register_Size_config(const Timer1_t *timer1_obj){
    if(1==timer1_obj->Timer1_WR_Reg_Mode){
        (T1CONbits.RD16 = 1);
    }
    else if(0==timer1_obj->Timer1_WR_Reg_Mode){
        (T1CONbits.RD16 = 0);
    }
    else{ }
}
