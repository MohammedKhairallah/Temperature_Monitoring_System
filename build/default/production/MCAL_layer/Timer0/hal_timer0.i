...
# 55 "MCAL_layer/Timer0/../Interrupt/mcal_interrupt_cfg.h"
...
static __attribute__((inline)) void Timer0_Prescaler_config(const Timer0_t *timer0_obj);
static __attribute__((inline)) void Timer0_Mode_Select(const Timer0_t *timer0_obj);
static __attribute__((inline)) void Timer0_Register_Size_config(const Timer0_t *timer0_obj);

static uint16_t Timer0_preload = 0x00;
# 31 "MCAL_layer/Timer0/hal_timer0.c"
Std_ReturnType Timer0_Initialize(const Timer0_t *timer0_obj){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer0_obj)
    {
...
# 78 "MCAL_layer/Timer0/hal_timer0.c"
        (T0CONbits.TMR0ON = 1);
    }
    return ret;
}
# 92 "MCAL_layer/Timer0/hal_timer0.c"
Std_ReturnType Timer0_Deinitialize(const Timer0_t *timer0_obj){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer0_obj)
    {
...
# 119 "MCAL_layer/Timer0/hal_timer0.c"
Std_ReturnType Timer0_Write_value(const Timer0_t *timer0_obj, uint16_t value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer0_obj)
    {
...
# 143 "MCAL_layer/Timer0/hal_timer0.c"
Std_ReturnType Timer0_Read_value(const Timer0_t *timer0_obj, uint16_t *value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8_t Timer0_L = 0x00;
    uint8_t Timer0_H = 0x00;
    if((((void*)0) == timer0_obj)||(((void*)0) == value))
    {
        ret = (Std_ReturnType)0x00;
    }else
    {
...
static __attribute__((inline)) void Timer0_Prescaler_config(const Timer0_t *timer0_obj){
    if(1==timer0_obj->Prescaler_Enable){
        (T0CONbits.PSA = 0);
        T0CONbits.T0PS = (timer0_obj->Prescaler_Value);
    }
    else if(0==timer0_obj->Prescaler_Enable){
        (T0CONbits.PSA = 1);
    }
    else{ }
}
...
static __attribute__((inline)) void Timer0_Mode_Select(const Timer0_t *timer0_obj){
    ...
    if(1==timer0_obj->Timer0_Mode){
        (T0CONbits.T0CS = 0);
    }
    else if(0==timer0_obj->Timer0_Mode){
        (T0CONbits.T0CS = 1);

        if(1==timer0_obj->Timer0_Counter_Edge){
            (T0CONbits.T0SE = 0);
        }
        else if(0==timer0_obj->Timer0_Counter_Edge){
            (T0CONbits.T0SE = 1);
        }
         else{ }
    }
...
static __attribute__((inline)) void Timer0_Register_Size_config(const Timer0_t *timer0_obj){
    if(1==timer0_obj->Timer0_Register_Size){
        (T0CONbits.T08BIT = 1);
    }
    else if(0==timer0_obj->Timer0_Register_Size){
        (T0CONbits.T08BIT = 0);
    }
    else{ }
}
