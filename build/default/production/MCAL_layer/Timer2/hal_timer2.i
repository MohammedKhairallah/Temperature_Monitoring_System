...
# 55 "MCAL_layer/Timer2/../Interrupt/mcal_interrupt_cfg.h"
...
static uint8_t Timer2_preload = 0x00;
# 26 "MCAL_layer/Timer2/hal_timer2.c"
Std_ReturnType Timer2_Initialize(const Timer2_t *timer2_obj){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer2_obj)
    {
    ...
    }else
    {
        ...
        (T2CONbits.T2CKPS = timer2_obj->Timer2_Prescaler_Value);

        (T2CONbits.TOUTPS = timer2_obj->Timer2_Postscaler_Value);

        TMR2 = timer2_obj->Timer2_Preload_Value;

        Timer2_preload = timer2_obj->Timer2_Preload_Value;
# 70 "MCAL_layer/Timer2/hal_timer2.c"
        (T2CONbits.TMR2ON = 1);
    }
    return ret;
}
# 84 "MCAL_layer/Timer2/hal_timer2.c"
Std_ReturnType Timer2_Deinitialize(const Timer2_t *timer2_obj){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer2_obj)
    {
...
# 111 "MCAL_layer/Timer2/hal_timer2.c"
Std_ReturnType Timer2_Write_value(const Timer2_t *timer2_obj, uint8_t value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == timer2_obj)
    {
...
# 133 "MCAL_layer/Timer2/hal_timer2.c"
Std_ReturnType Timer2_Read_value(const Timer2_t *timer2_obj, uint8_t *value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if((((void*)0) == timer2_obj)||(((void*)0) == value))
    {
        ret = (Std_ReturnType)0x00;
    }else
    {
